...
limits=pvalue;
[train_instances,~]=size(training);


[test_instances,~]=size(testing);
...
clear i;
    [~, l]=size(training);         %CALCULATE SIZE OF DATA
...
test_mad=(cleanUp(test_mad));
training_mad=(cleanUp(training_mad));
