...
function xval=comparisonTestsRapid(features,labels,subs,p,fs)

%--------------------------------------------------------------------------
 % comparisonTestsRapid

 % Last updated: December 2019, J. LaRocco

 % Details: Testing is still performed on a subject it has not seen before.  
 % Usage:
